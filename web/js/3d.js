            ...
            if (i % 2) {
                ...
                for (var k = 0; k < vars.shapes[i].polys[j].segs.length; ++k) {
                    ...
                    if (point1.d != -1) {
                        ...
                        if (point2.d != -1) {
                            vars.ctx.strokeStyle = "#b2b2b4";
                            vars.ctx.lineWidth = 15 / (5 + point1.d);
                            vars.ctx.beginPath();
...
function frame(vars) {
    ...
    if (vars === undefined) {
        ...
        vars.canvas.height = $('.banner-container').height();
